...
\quad3.1 The Environment for Using Beacon

\quad3.1-1 Bluetooth 

\quad3.1-2 OS

\quad3.2 Server requirement

\quad3.2-1 How to send information 

\quad3.2-2 Need for back-end server

\quad3.3 User requirement 

\quad3.3-1 Accuracy

\quad3.3-2 Unimportant data 

\quad3.3-3 Push alarm

\quad3.3-4 Exhibition list

\quad3.3-5 Map

\quad3.3-6 Location of work the exhibition 

\quad3.3-7 Work button

\quad3.3-8 Work picture

\quad3.3-9 Text box1

\quad3.3-10 Text box2

\quad3.3-11 Voice button

\quad3.3-12 Previous exhibition

\quad3.3-13 Delete function

\quad3.3-14 Reporting problem

\quad3.4 Customer requirement\\

IV. Develop environment

\quad4.1 Choice of software development platform

\quad4.1-1 Which platform and why?

\quad4.1-2 Which programming language and why?

\quad4.2 A cost estimation

\quad4.3 Information of development environment

\quad4.4 Using commercial cloud platform\\

V. Specification

\quad5.1 Modeling for Specifications 

\quad5.2 Prototype for Specifications

\quad5.3 Specifications for front-end application pages
...
\quad5.4 Specifications for Server
...
\quad6.1 Overall architecture

\quad6.2 Directory organization

\quad6.3 Code analysis
...
\quad7.1 BLE searching and push notice

\quad7.2 Temporary Activity

\quad7.3 Main Application\\
